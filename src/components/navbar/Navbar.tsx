...
export default function Navbar(): JSX.Element {
    ...
    return (
        ...
        <aside className={`sidebar ${isOpen ? "open" : ""}`}>
            <div className="sidebar__content" onClick={(event) => event.stopPropagation()}>
                <InputSearchNavbar/>
                <ItemsNavbar titleItem="Home" />
                <ItemsNavbar titleItem="Genre" />
                <ItemsNavbar titleItem="Country" />
                ...
                <div className="sidebar__containerButton">
                    <button className="button" onClick={closeSideBar}>Regresar</button>
                </div>
            </div>
        </aside>
        ...
        <div className="container__button">
            <button className="navbar__button" onClick={() => setIsOpen(true)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 24 24"><path fill="white" d="M3 18v-2h18v2zm0-5v-2h18v2zm0-5V6h18v2z"/></svg>
            </button>
        </div>
