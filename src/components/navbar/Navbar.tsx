...
export default function Navbar(): JSX.Element {
    return (
        <nav style={{ backgroundColor: "#000", padding: "1.5rem", display: "flex", justifyContent: "center" }}>
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", maxWidth: "800px", gap: "1rem" }}>
