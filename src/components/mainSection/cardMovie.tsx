...
export const CardMovie = ({title, name, poster_path, vote_average, episode}: PropCard) => {
    ...
    <div className="cardModelBasicMovie__containerCard">
        <button className={episode ? "cardModelBasicSeries" : "cardModelBasicMovie"}>
            <img src={`https://image.tmdb.org/t/p/w500/${poster_path}`} alt="" className={episode ? "cardSeries" : ""} />
            {
                episode && (
        ...
        <div className="cardModelBasicMovie__detail">
            ...
            <div className="cardModelBasicMovie__moreDetail">
                <p className="cardModelBasicMovie__detailHD">
                    HD
                </p>
                <p>
